...
/* runtime NID resolution targets; the SceSyscon module/lib NIDs, the
 * BlinkType2 NID and the hardware-confirmed off/release patterns live in
 * power_led.h, shared with the release plugin */
